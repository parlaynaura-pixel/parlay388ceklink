...
<body>
            ...
            <div>
                <div class="input-section">
                    ...
                    <div class="jackpot-display">
                        ...
                        <div class="jackpot-amount" id="jackpot">IDR 888.970.445</div>
                    </div>
                </div>
                ...
                <div class="winners-section">
                    ...
                    <div class="winner-prize">IDR 2.000.000</div>
                </div><div class="winners-table-row">
    ...
    <script>
        const PRIZES = ["2JT", "500K", "750K", "1JT", "1,5JT", "250K"];
        const PRIZE_AMOUNTS = ["2.000.000", "500.000", "750.000", "1.000.000", "1.500.000", "250.000"];
